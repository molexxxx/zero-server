...
module.exports = [
		...
		items: [
			...
			},
			{
				...
				options: [
					...
					{ option: '@zero-server/webrtc',     type: 'webrtc',     default: '-',     notes: 'Signaling hub, rooms/peers, STUN/TURN, SFU adapters (memory, mediasoup, LiveKit), join tokens, E2EE, spawnBotPeer.' },
	 ...
	 * so the docs site never shows "Source file not found." placeholders. */
	{
		...
		items: [
			...
			{ name: 'Cascade Coordinator',  source: 'lib/webrtc/cascade.js' },
			{ name: 'MCU Adapter',          source: 'lib/webrtc/mcu/index.js' },
			{ name: 'Ffmpeg MCU Adapter',   source: 'lib/webrtc/mcu/ffmpeg.js' },
			{ name: 'Recording Manager',    source: 'lib/webrtc/recording.js' },
