...
for (const scope of scopes) {
    ...
    if (fs.existsSync(pkgDir)) {
        const pkgReadme = [
            ...
            '## Public surface',
            '',
            `This package provides **${scope.exports.length}** public exports as a standalone runtime bundle. See the [scope page](https://github.com/molexxxx/zero-server/blob/main/docs/scopes/${scope.name}.md#public-surface) for the full list.`,
            '',
            '## Documentation',
            '',
            '- [Scope page](https://github.com/molexxxx/zero-server/blob/main/docs/scopes/' + scope.name + '.md)',
            '- [Full API reference](https://github.com/molexxxx/zero-server/blob/main/API.md)',
